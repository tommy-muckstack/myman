...
This package is prepared for submission; marketplace listing and a live GrokBot invocation have not been verified. See [submission and verification status](../../docs/grok-bot-marketplace.md). The repository-root plugin provides separate read-only retrieval and permission-controlled app-action MCP servers for clients running locally on the Mac.
...
Candidate 0.8.0 adds recipes for screenshot comparison, word targets, video finishing, readiness waits and font-quality reports. Check the running app’s capabilities first; the package alone does not update the Mac app.
