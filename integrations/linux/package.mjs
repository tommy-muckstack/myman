...
try {
 ...
 for(const relative of ['scripts/install-linux.sh','integrations/linux/install.mjs','integrations/linux/bundle','src/Resources/BrainCompanion/server.mjs','src/Resources/BrainCompanion/cli.mjs','src/Resources/BrainCompanion/LICENSES.txt','src/Resources/Fonts/Gellix-SemiBold.ttf','README.md','docs/linux-agents.md','LICENSE']) {
