...
export const flags = ['json', 'help', 'id', 'query', 'kind', 'limit', 'offset', 'after', 'before', 'title', 'body', 'body-file', 'file', 'display', 'region', 'window-id', 'coordinates', 'ops', 'ops-file',
  ...
  'source-id', 'path', 'alt', 'confirm', 'pinned-only', 'lexical-only', 'semantic', 'notes', 'due', 'clear-due', 'state', 'mode', 'no-system-audio', 'keep-audio', 'max-minutes', 'full', 'auto-zoom', 'recipe', 'hide-cursor', 'cursor', 'background', 'background-color', 'corner-radius'];
