...
export async function read({ id }) {
  ...
  const body = entry.kind === 'notes' ? noteBody(rest) : doc.text;
  return publicItem(entry, root, { updated_at: updatedAt(entry, fields), body, characters: body.length, source: brain.source(doc) });
}
