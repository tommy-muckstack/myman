...
@MainActor enum WorkflowActivity {
    ...
    static let cancellable: Set<String> = ["screenshot.ocr", "screenshot.compare", "recording.frames", "recording.export", "recording.polish", "demo.run", "font.match", "font.preview"]
