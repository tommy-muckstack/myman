...
```json
{"title": "Spotify in 20 seconds", "steps": [{"click": "Search", "caption": "Search for a song"}, {"type": "lofi beats"}, {"key": "Return"}, {"wait": 1.5}, {"click": "Play", "nth": 1}]}
```
