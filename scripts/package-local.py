...
info = dict(CFBundleExecutable='MyMan', CFBundleIdentifier='com.muckstack.myman.preview', CFBundleName='My Man Preview', CFBundlePackageType='APPL', CFBundleShortVersionString='1.1.63-preview', CFBundleVersion='75', LSMinimumSystemVersion='14.2', NSHighResolutionCapable=True, NSMicrophoneUsageDescription='Record audio when you start dictation or a recording.', NSCameraUsageDescription='Show your camera when explicitly enabled.', NSScreenCaptureUsageDescription='Capture the screen when you request a screenshot or recording.')
